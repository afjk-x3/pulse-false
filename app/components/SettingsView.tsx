    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div className={`p-6 bg-white rounded-2xl border ${highContrast ? 'border-black text-black' : 'border-[#f1f0ea]'
        ...
        <form onSubmit={handleSave} className="space-y-5">
          ...
          {errorMsg && (
            <div className="p-3.5 bg-red-50 border border-red-100 rounded-xl text-xs text-red-700 flex items-start gap-2 font-semibold leading-normal animate-fade-in">
