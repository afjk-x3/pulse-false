          ...
          <div className="lg:col-span-5 border-t lg:border-t-0 lg:border-l border-neutral-100 lg:pl-6 pt-6 lg:pt-0">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-1">
                <button onClick={handlePrevMonth} className="p-1 rounded-lg border border-neutral-200 hover:bg-neutral-50">
                  <ChevronLeft className="h-3.5 w-3.5 text-neutral-500" />
                </button>
                <button onClick={handleNextMonth} className="p-1 rounded-lg border border-neutral-200 hover:bg-neutral-50">
