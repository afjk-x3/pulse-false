...
export default function SupportCircles() {
 ...
 return (
 <>
 <Card className={`grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100vh-160px)] glass-card bg-transparent border-transparent shadow-none rounded-2xl overflow-hidden ${highContrast ? 'text-black' : ''}`}>
