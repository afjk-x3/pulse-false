...
export default function MicroCoachingNudge() {
  ...
  return (
    <>
      ...
      {isVisible && (
        <div 
          className={`fixed bottom-6 right-6 z-40 max-w-sm p-5 rounded-2xl bg-white shadow-2xl border flex gap-4 transition-all duration-300 transform translate-y-0 animate-slide-up ${
      ...
      {isTimerOpen && (
        <div 
          className="fixed inset-0 z-50 flex items-center justify-center bg-[#FAF9F6]/95 backdrop-blur-md animate-fade-in"
          role="dialog"
          aria-modal="true"
