...
export default function AppShell({ children}: { children: React.ReactNode}) {
 ...
 <Image src="/pulse_login_hero.jpg" alt="Pulse Telemetry Abstract" fill sizes="50vw" className="object-cover opacity-80" priority />
 ...
 <p className="text-sm text-neutral-300 font-medium leading-relaxed">Privacy-first workplace health monitoring.</p>
 </div>
 </div>
 </div>
 ...
 <h2 className="text-2xl font-extrabold text-neutral-900 tracking-tight">Welcome back</h2>
