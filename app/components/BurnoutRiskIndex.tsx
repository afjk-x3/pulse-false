...
export default function BurnoutRiskIndex({ onNavigateToTab, refreshTrigger}: BurnoutRiskIndexProps) {
 ...
 if (highContrast) {
 if (score === 1) return'glass-card border-2 border-green-700 text-green-800 font-bold';
 if (score === 2) return'glass-card border-2 border-blue-700 text-blue-800 font-bold';
 return'glass-card border-2 border-red-700 text-red-800 font-bold';
}
